CLASS zcl_sac_tb_update_itm DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_SAC_TB_UPDATE_ITM IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DATA lt_bill_item TYPE STANDARD TABLE OF ztb_sac_item.

    DELETE FROM ztb_sac_item.
    ...
    INSERT ztb_sac_item FROM TABLE @lt_bill_item.
